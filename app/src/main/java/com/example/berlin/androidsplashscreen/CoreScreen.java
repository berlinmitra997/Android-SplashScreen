package com.example.berlin.androidsplashscreen;
...
public class CoreScreen extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (v.getId()){
            case R.id.btn_next:
                if (buttonNext.getText().toString().equalsIgnoreCase("next")){
                    ...
                    startActivity(new Intent(CoreScreen.this, DashActivity.class));
                }
                break;
